...
#########     Fourier Grapher    ###########
############################################
# copied from Devansh Kukreja TP - Pulse 
...
class Graph(object): #The normal graphs in the top-right for instant and average energies
    ...
    def draw(self, points, canvas):
        ...
        if (self.unified): 
        #The group of graphs in the top-right share the same maxValues since 
        ...
        #The fourier graph in the center is on its own scale, 
        # so it has its own maxValue.
